          ...
          <div className="card">
            ...
            <Modal show={show} onHide={handleClose}>
              <Modal.Header closeButton>
                <Modal.Title>Atender Emergencia</Modal.Title>
              </Modal.Header>
              <Form.Select aria-label="Default select example" defaultValue={estado_emergencia}  onChange={(e) => setEstado_emergencia(e.target.value)}>
